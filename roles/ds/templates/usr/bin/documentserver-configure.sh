...
LOCAL_CONFIG="/etc/r7-office/documentserver/local.json"
EXAMPLE_CONFIG="/etc/r7-office/documentserver-example/local.json"
...
AMQP_SERVER_HOST_PORT_PATH="localhost"
...
setup_nginx(){
  NGINX_CONF_DIR=/etc/r7-office/documentserver/nginx
